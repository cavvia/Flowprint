    class NetworkImporter 
    {
      ...
      public static final int LDNBUS = 0;
      public static final int LDNSUB = 1;
      public static final int PARSUB = 2;
      public static final int NYCSUB = 3;
      public static final int LDNCYCLE = 4;
      public static final int LDNCYCLEWK = 5;
      public static final int LDNCYCLEWKEND = 6;
     ...
     public NetworkImporter(int netID)
     {        
      this.filemap = new String[7];
       this.filemap[NetworkImporter.LDNBUS] = "ldn_bus";
       this.filemap[NetworkImporter.LDNSUB] = "ldn_underground";       
       this.filemap[NetworkImporter.PARSUB] = "PAR";
       this.filemap[NetworkImporter.NYCSUB] = "NYC";         
       this.filemap[NetworkImporter.LDNCYCLE] = "cyclehire";             
       this.filemap[NetworkImporter.LDNCYCLEWK] = "cyclehirewk";                  
       this.filemap[NetworkImporter.LDNCYCLEWKEND] = "cyclehirewkend";                         
       this.setFilePrefix(netID);
     }
     ...
     {
       debug(this.filemap.toString());
       this.filePrefix = filemap[networkID];
     }
     
     private String getStopsFile()
     {
       return "dat/" + this.filePrefix + "_stops.csv";
     }
     
     private String getEdgesFile(Boolean ncol)
     {
       String suffix = ncol ? ncolSuffix : "csv";
       return "dat/" + this.filePrefix + "_routes." + suffix;
     }     
     
     private String getAttribFile(String attrib)
     {
       String suffix = "csv";
       return "dat/" + this.filePrefix + "_" + attrib + "." + suffix;
     }         
